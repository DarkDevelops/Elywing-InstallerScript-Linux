...
echo "$time [INFO] Starting Elywing-2.0-master installation..."
time=$(date +"%T") &> /dev/null
...
wget --no-check-certificate https://github.com/zCode2019/Elywing-2.0/archive/master.zip &> /dev/null
chmod 777 master.zip &> /dev/null
time=$(date +"%T") &> /dev/null
echo "$time [INFO] Un-Zipping..."
unzip -o master.zip &> /dev/null
chmod 777 Elywing-2.0-master-master &> /dev/null
cd Elywing-2.0-master-master &> /dev/null
...
cd .. &> /dev/null
rm -rf Elywing-2.0-master &> /dev/null
